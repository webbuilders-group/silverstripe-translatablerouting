...
class MultilingualControllerExtension extends Extension {
    ...
    public function onBeforeInit() {
        ...
        if($request && $request->param('Language')) {
            ...
            if(MultilingualRootURLController::get_use_locale_url()) {
                ...
                $default=(MultilingualRootURLController::get_use_locale_url() ? Translatable::default_locale():Translatable::default_lang());
    ...
    public function MultilingualLink() {
        return Controller::join_links((MultilingualRootURLController::get_use_locale_url() ? i18n::get_locale():i18n::get_lang_from_locale(i18n::get_locale())), get_class($this->owner)).'/';
    }
}
?>